...
var fizzBuzz = function(n) {
	if (n === 0) return [];
	if (!(n%5) && !(n%3)) return fizzBuzz(--n).concat(["FizzBuzz"]);
	else if (!(n%5)) return fizzBuzz(--n).concat(["Buzz"]);
	else if (!(n%3)) return fizzBuzz(--n).concat(["Fizz"]);
	return fizzBuzz(--n).concat([(n+1).toString()]);
};
